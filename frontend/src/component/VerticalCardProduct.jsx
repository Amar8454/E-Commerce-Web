...
const VerticaCardProduct = ({ category, heading }) => {
  ...
  return (
    <div className="container mx-auto px-4 my-4 relative">
      <div>
        ...
        >
          <button
            className="bg-white shadow-md rounded-full p-1 text-lg absolute left-0 hidden md:block"
            onClick={LeftScroll}
          >
            <FaAngleLeft />
          </button>
          <button
            className="bg-white shadow-md rounded-full p-1 text-lg absolute right-0 hidden md:block "
            onClick={RightScroll}
          >
            <FaAngleRight />
          </button>
...
export default VerticaCardProduct;
